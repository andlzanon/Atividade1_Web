...
import br.ufscar.dc.hotel.forms.NovoSiteFormBean;
...
public class GravarSiteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            NovoSiteFormBean nsfb = (NovoSiteFormBean)request.getSession().getAttribute("novoSite");
            request.removeAttribute("novoSite");
            
            SiteDAO siteDAO = new SiteDAO(dataSource);
            Site site = new Site();
            site.setUrl(nsfb.getUrl());
            site.setNome(nsfb.getNome());
            site.setTelefone(nsfb.getTelefone());
            site.setSenha(nsfb.getSenha());
            site = siteDAO.gravarSite(site);
            
            request.setAttribute("mensagem", "Site adicionado com sucesso");
